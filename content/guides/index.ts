...
import { riversideGuide } from "@/content/guides/riverside-golf-course"
 ...
 */
const published: Guide[] = [lionsGuide, royKizerGuide, riversideGuide].filter((g) => courseBySlug.has(g.slug))
